...
<div class="zp-thankyou">
    <section class="zp-thankyou__hero" aria-labelledby="zp-thankyou-title">
        ...
        <p class="zp-thankyou__eyebrow"><?php esc_html_e( 'Članstvo aktivirano', 'zaherpilates' ); ?></p>
        <h1 id="zp-thankyou-title" class="zp-thankyou__title">
            <?php esc_html_e( 'Dobrodošla u Zaher Pilates!', 'zaherpilates' ); ?>
        </h1>
    ...
    <section class="zp-thankyou__next" aria-label="<?php esc_attr_e( 'Sljedeći koraci', 'zaherpilates' ); ?>">
        <a class="zp-next-card" href="<?php echo esc_url( $account_url ); ?>">
            ...
            <span class="zp-next-card__title"><?php esc_html_e( 'Moj račun', 'zaherpilates' ); ?></span>
            <span class="zp-next-card__text"><?php esc_html_e( 'Pregledaj pretplatu, podatke i postavke profila.', 'zaherpilates' ); ?></span>
        </a>
        ...
        <section class="zp-thankyou__details" aria-labelledby="zp-thankyou-details-title">
            ...
            <div class="zp-thankyou__details-body">
                <div class="zp-thankyou__summary">
                    <div>
                        <span><?php esc_html_e( 'Broj narudžbe', 'zaherpilates' ); ?></span>
                ...
                <?php if ( class_exists( 'MePdfInvoicesCtrl' ) ) : ?>
                    <a class="mepr-invoice-print zp-thankyou__print" href="<?php echo esc_url( MeprUtils::admin_url(
                        ...
                        <?php esc_html_e( 'Preuzmi račun (PDF)', 'zaherpilates' ); ?>
                    </a>
                <?php endif; ?>
            </div>
        </section>
