...
SVG,
			'check'        => <<<SVG
<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M20.2929 5.29289C20.6834 4.90237 21.3166 4.90237 21.7071 5.29289C22.0976 5.68342 22.0976 6.31658 21.7071 6.70711L9.70711 18.7071C9.31658 19.0976 8.68342 19.0976 8.29289 18.7071L2.29289 12.7071C1.90237 12.3166 1.90237 11.6834 2.29289 11.2929C2.68342 10.9024 3.31658 10.9024 3.70711 11.2929L9 16.5858L20.2929 5.29289Z" fill="currentColor"/>
</svg>
SVG,
			'layout'       => <<<SVG
<svg width="1em" height="1em" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
SVG,
			'heart-filled' => <<<SVG
<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12.1773 4.77135L12 4.94862L11.8227 4.77124C9.5756 2.52417 5.93237 2.52417 3.6853 4.77124C1.43823 7.01831 1.43823 10.6615 3.6853 12.9086L10.409 19.6324C11.2877 20.5111 12.7123 20.5111 13.591 19.6324L20.3147 12.9087C22.5618 10.6616 22.5618 7.01842 20.3147 4.77134C18.0676 2.52427 14.4244 2.52427 12.1773 4.77135Z" fill="currentColor"/>
</svg>
SVG,
			'refresh'      => <<<SVG
<svg width="1em" height="1em" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function zaher_favorites_list_button_html( $html, $post_id, $favorited, $site_id ) {
	if ( empty( $GLOBALS['zaher_favorites_list_context'] ) ) {
		// Default card button - show both icons (CSS toggles visibility)
		return '<span class="icon-heart">' . zaher_lineicon_svg( 'heart' ) . '</span><span class="icon-heart-filled">' . zaher_lineicon_svg( 'heart-filled' ) . '</span>';
	}
