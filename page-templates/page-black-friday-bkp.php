<?php
/*
Template Name: Black Friday Landing
*/
...
<main class="main landing landing--black-friday">
	...
	<section class="hero hero--black-friday">
		<div class="grid-container">
			<div class="hero__content">
				<div class="hero__kicker">Black Friday 2024</div>
				<header class="hero__header">
					<h1 class="hero__title">Najveći LOOP popust do sada: treniraj cijelu godinu uz 40% nižu cijenu</h1>
	...
	<section class="pricing-plans section bf-offer">
		<div class="grid-container">
			<header class="section__header section__header--center">
				<div class="section__subtitle">Uštedi sada</div>
				<h2 class="section__title">Black Friday članstvo</h2>
				<div class="section__desc">
					<p>Plati jednom, treniraj cijelu godinu i osiguraj si sve nove programe koji izlaze 2025.</p>
				</div>
			</header>

			<div class="bf-offer__grid">
				<div class="bf-offer__card">
					<span class="bf-offer__badge">Najtraženije</span>
					<div class="bf-offer__price">
						<del>€199</del>
						<span>€119</span>
					</div>
					<div class="bf-offer__savings">Štediš €80 i dobivaš sve buduće nadogradnje uključene.</div>
					<ul class="bf-offer__list">
						<li>12 mjeseci neograničenog pristupa LOOP platformi</li>
						<li>Programi za svaku fazu ciklusa i životnog ritma</li>
						<li>Live treninzi i snimke dostupne 48 h nakon termina</li>
						<li>Ekskluzivna zatvorena community grupa</li>
						<li>Bonus: digitalni vodič za planiranje treninga kroz mjesec</li>
					</ul>
					<div class="bf-offer__cta">
						<a class="button button--large" href="<?php echo $cta_url; ?>">Uzmi Black Friday ponudu</a>
					</div>
				</div>
				<div class="bf-offer__card">
					<span class="bf-offer__badge">Poklon</span>
					<div class="bf-offer__price">
						<del>€59</del>
						<span>€0</span>
					</div>
					<div class="bf-offer__savings">Uključeno gratis uz Black Friday kupnju.</div>
					<ul class="bf-offer__list">
						<li>4-tjedni program "Reset &amp; Recharge" za blagu fazu ciklusa</li>
						<li>Audio vođene mini rutine za brzu regeneraciju</li>
						<li>Checklist za praćenje energije i odmora</li>
						<li>Pristup specijalnoj radionici o prehrani kroz ciklus</li>
						<li>PDF plan zaporavka nakon stresnog perioda</li>
					</ul>
					<div class="bf-offer__cta">
						<a class="button button--hollow" href="<?php echo $cta_url; ?>">Dodaj u svoju košaricu</a>
					</div>
				</div>
			</div>
		</div>
